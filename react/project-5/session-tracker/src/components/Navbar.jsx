      ...
      <div className="flex justify-between items-center w-full px-4 sm:px-8 py-4 w-full mx-auto">
        <div className="flex items-center gap-4 sm:gap-8">
          ...
          <div className="relative hidden sm:block">
            ...
            />
            <input
              className="border-none rounded-full py-2 pl-10 pr-4 text-sm w-64 outline-blue-300 transition-all bg-blue-100 transition-colors hover:bg-blue-200 duration-300"
              placeholder="Search..."
              type="text"
            />
          </div>
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full overflow-hidden border-2 border-surface-container-highest shrink-0">
            <img
              alt="User profile"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuANZwobV5Oz8CSDRRX10faItKudkHryyDcgS6B30fAR6ZRFHe4rkDtwVEyRsg4FDI4wjcvqmba4ov-u4W68cIY_dVa35U2tIm3XLFkbuHlnm9z8VwQ_tgJdktTdbgV64oxgT9qooSbZa9ZMlJOTgXYEZ1dyFVfm9isiyFCLei2eHRxmBh4TMMM0f58BBbRB1HIhCojE_mGPqyzSTNgX8PXY_yIoKGAn9stiOnMGOcM_KxqVEl97obcpkUsvlF52vTtAJss5NYzK3lOI"
